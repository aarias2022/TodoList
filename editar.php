...
$query = $con->prepare("SELECT tareas FROM tareas WHERE id = :id");
$query->execute(['id' => $id, 'activo']);
$num = $query->rowCount();
if ($num > 0) {
                ...
                <div class="col">
                    <form class="row g-3" method="POST" action="guarda.php" autocomplete="off">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="tarea" name="tarea" class="form-control" required autofocus>
                        </div>
